...
public class CoverageMatricTest {

	private CoverageMatric cm;

	@Before
	public void init() {
		cm = new CoverageMatric();
	}
	...
	@Test
	public void op1_isnot_null_but_op2_is_null() {
	...
	@Test
	public void op1_isnot_null_but_op2_isnot_null() {
		Integer op1 = new Integer("10");
		Integer op2 = new Integer("5");
		int ExpectedRlt = 15;
